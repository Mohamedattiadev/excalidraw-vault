...
[[02-Personal/11-Dev-101/Terminal-101/01-command-line-basics/index\|← Chapter 1]] | [[02-Personal/11-Dev-101/Terminal-101/index\|back to Terminal 101]] | [[02-Personal/11-Dev-101/Terminal-101/03-files-and-navigation/index\|next: Chapter 3 →]]
...
- one folder here per user, and by default they can not write inside each other's one. that is the permission system from [[02-Personal/11-Dev-101/Terminal-101/05-permissions-sudo/index\|Chapter 5]] doing its job.
...
- these files get long, so `less` and `tail` from [[02-Personal/11-Dev-101/Terminal-101/03-files-and-navigation/index\|Chapter 3]] are the right way to read them, not `cat`.
...
- don't worry about the `|` and the `grep` in that command, they are [[02-Personal/11-Dev-101/Terminal-101/04-search-grep-find/index\|Chapter 4]] and [[02-Personal/11-Dev-101/Terminal-101/08-io-pipes-processes/index\|Chapter 8]]. u are just seeing them early.
...
> and this is why `which` works the way it does, which we will see properly in [[02-Personal/11-Dev-101/Terminal-101/07-scripts-env-path/index\|Chapter 7]]:
...
> stuck, or done and want to check? [[02-Personal/11-Dev-101/Terminal-101/02-the-linux-file-system/solutions\|the solutions are here]]
