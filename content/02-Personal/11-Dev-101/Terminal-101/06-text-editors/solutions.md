...
[[02-Personal/11-Dev-101/Terminal-101/06-text-editors/index\|back to the chapter]]
...
- in step 8 notice `>>` and not `>`, exactly like the alias in [[02-Personal/11-Dev-101/Terminal-101/07-scripts-env-path/index\|Chapter 7]]. with `>` u would erase ur whole `.bashrc`.
