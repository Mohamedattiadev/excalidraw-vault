...
[[02-Personal/11-Dev-101/Terminal-101/03-files-and-navigation/index\|back to the chapter]]
...
- in step 4 the `>` is redirecting the output of `echo` into the file instead of the screen, we learn it properly in [[02-Personal/11-Dev-101/Terminal-101/08-io-pipes-processes/index\|Chapter 8]].
