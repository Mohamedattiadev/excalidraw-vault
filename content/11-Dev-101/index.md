...
|---|---|---|---|---|
| [[11-Dev-101/Terminal-101/index\|Terminal 101]] | **finished** | ~11h 15min | [[11-Dev-101/Terminal-101/watch\|watch, 24 min]] | the shell, the linux file tree, permissions, editors, scripts, pipes, processes, bash scripting |
| Git & GitHub | planned | - | *when the course is* | commits, branches, merges, remotes, pull requests |
