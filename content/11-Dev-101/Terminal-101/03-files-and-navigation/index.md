...
[[11-Dev-101/Terminal-101/02-the-linux-file-system/index\|← Chapter 2]] | [[11-Dev-101/Terminal-101/index\|back to Terminal 101]] | [[11-Dev-101/Terminal-101/04-search-grep-find/index\|next: Chapter 4 →]]
...
> and now, when we get to `find` in [[11-Dev-101/Terminal-101/04-search-grep-find/index\|Chapter 4]] and it tells u to put ur pattern in quotes, u will know exactly why. the quotes stop the shell from eating the star, so that `find` gets to see it and use it itself.
...
> in [[11-Dev-101/Terminal-101/07-scripts-env-path/index\|Chapter 7]] we will learn how to make ur own shortcuts with `alias`, and how to keep them forever in the `.bashrc` file.
...
> stuck, or done and want to check? [[11-Dev-101/Terminal-101/03-files-and-navigation/solutions\|the solutions are here]]
