...
[[11-Dev-101/Terminal-101/index\|← back to Terminal 101]] | [[11-Dev-101/Terminal-101/02-the-linux-file-system/index\|next: Chapter 2 →]]
...
> note: the `cd` command is used to change the directory, we will learn it in [[11-Dev-101/Terminal-101/03-files-and-navigation/index\|Chapter 3]].
...
- the full explanation is in the [[11-Dev-101/Terminal-101/index\|course README]], under "before u start".
...
> stuck, or done and want to check? [[11-Dev-101/Terminal-101/01-command-line-basics/solutions\|the solutions are here]]
