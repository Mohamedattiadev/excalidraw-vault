...
[[11-Dev-101/Terminal-101/04-search-grep-find/index\|← Chapter 4]] | [[11-Dev-101/Terminal-101/index\|back to Terminal 101]] | [[11-Dev-101/Terminal-101/06-text-editors/index\|next: Chapter 6 →]]
...
> the `./` is there because of the path shortcuts we learned in [[11-Dev-101/Terminal-101/03-files-and-navigation/index\|Chapter 3]], `.` is the current dir. we will see why it is needed at all when we learn the `PATH` variable in [[11-Dev-101/Terminal-101/07-scripts-env-path/index\|Chapter 7]].
...
> stuck, or done and want to check? [[11-Dev-101/Terminal-101/05-permissions-sudo/solutions\|the solutions are here]]
